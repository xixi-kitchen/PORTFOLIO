...
function Homepage({ ...props }) {
  ...
  return (
    <div className="relative left-0 right-0 top-[0px] h-[7444px] overflow-hidden bg-[#d4d4d4]">
      <div className="absolute left-[209px] right-[209px] top-[226px] flex flex-col items-center justify-start gap-[61px]">
        ...
        <div className="relative flex shrink-0 flex-col items-start justify-start gap-2.5 self-stretch">
          ...
          >
            Human design studio is a virtual studio consisting of a designer who
            likes to do all kinds of novelty experiments, and an artificial
            intelligence (who is actually a person). When our design concept is
            unchanged, it is to make design more in line with life, conducive to
            life, benefit life, and let design serve human beings.
          </div>
      ...
      <div className="absolute left-[209px] right-[834px] top-[1324px] flex h-[316px] flex-col items-start justify-start gap-2.5">
        ...
        >
          ...
          defined by industrial design, I prefer to call myself a [designer], I
          like to design all kinds of things, and I like to learn more new
          things and integrate them into my design work, from the most
          proficient industrial design to more cutting-edge interaction design,
          to advanced artificial intelligence, I am very interested and have
          been committed to systematic learning in these fields, and then
          combine it with my own design to make my design more diverse. It can
          better meet the increasingly diverse needs of human beings for design.
          Make design more human-friendly!
        </div>
      ...
      <div className="absolute left-[209px] right-[209px] top-[2124px] flex flex-col items-start justify-start gap-2.5">
        ...
        >
          ...
          relatively complete design log. The design log of these works records
          the whole process of the work from the initial demand proposal, to the
          demand research, design analysis, inspiration burst, model
          verification and final product confirmation, and more completely
          records how a design product from the demand to the final presentation
          of the whole process, because the whole process is more perfect, so as
          a project to display, the design log is introduced on a separate page
        </div>
      ...
      <div className="absolute left-[209px] right-[209px] top-[5912px] flex flex-col items-start justify-start gap-2.5">
        ...
        >
          ...
          needs of others and the temporary creativity of individuals, and there
          is no complete design log or detailed production record, so they are
          displayed in a single form. Most creative categories.
        </div>
      ...
      <div className="absolute left-0 right-0 top-[3919px] flex h-[1672px] flex-col items-center justify-start gap-10">
        <div
          ...
          onClick={goAerobic}
        >
          <img className="relative flex-1 self-stretch" src="homepage-6.png" />
        ...
        <div
          className="relative flex flex-1 flex-col items-start justify-start gap-2.5 self-stretch"
          onClick={goMigiccomb}
        >
          <img className="relative flex-1 self-stretch" src="homepage-7.png" />
        ...
        <div
          className="relative flex flex-1 flex-col items-start justify-start gap-2.5 self-stretch bg-[#f3f3f3]"
          onClick={goSaint}
        >
        ...
        <div
          className="relative flex flex-1 flex-col items-center justify-start gap-2.5 self-stretch"
          onClick={goTwoface}
        >
          <img className="relative flex-1 self-stretch" src="homepage-9.png" />
        ...
        <div
          ...
          onClick={goNotlack}
        >
          <img className="relative flex-1 self-stretch" src="homepage-10.png" />
